    ...
    return (
        <header className="flex justify-between text-xs">
            ...
            <div className="relative bg-opacity-100 backdrop-blur-lg rounded-md">
                <input type="text" placeholder="Search" className="bg-black bg-opacity-30 placeholder-gray-300 placeholder:font-medium text-white rounded-md py-2 pl-8 pr-4 w-52 focus:outline-none " onChange={(e) => setCity(e.target.value)}
                />
